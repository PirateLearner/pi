...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogContent.publication_start'
        db.add_column(u'blogging_blogcontent', 'publication_start',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogContent.publication_start'
        db.delete_column(u'blogging_blogcontent', 'publication_start')

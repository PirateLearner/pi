...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlogContent.data'
        db.alter_column(u'blogging_blogcontent', 'data', self.gf('djangocms_text_ckeditor.fields.HTMLField')())

    def backwards(self, orm):

        # Changing field 'BlogContent.data'
        db.alter_column(u'blogging_blogcontent', 'data', self.gf('django.db.models.fields.TextField')())

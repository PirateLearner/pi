...
from django.urlss import resolve
...
#        self.assertEqual(obj.func, home)
    ...
    def test_create_annotation(self):
        self.create_annotation(body='This is a test annotations', paragraph=1)
...
class TestSerializers(TestAnnotations):
    ...
    def test_view_annotations(self):
        self.create_annotation(body='This is a test annotations 1', paragraph=1)
    ...
    def test_POST_annotation(self):
        ...
        #print(annotations.content_object)
        self.assertEqual(annotation.body, 'Dreaming is good, day dreaming, not so good.')
        self.assertEqual(annotation.paragraph, 1)
    ...
    def test_PUT_annotation(self):
        ...
        string_data = {
                    ...
                    'object_id':'1',
                    'paragraph':'1',
                    'body':'This is the updated annotations',
                    'author':str(self.user.id),
                    'privacy':'3',
                    'privacy_override': '0',
                    'shared_with': ['1'],
        ...
        self.assertEqual(annotation.body, 'This is the updated annotations')
        self.assertEqual(annotation.paragraph, 1)

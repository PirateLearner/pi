...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'annotation_annotation_share_map', (
            ...
            ('annotations', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotations.Annotation'])),
            ('notified_flag', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('annotations', ['Annotation_share_map'])
    ...
    models = {
        'annotations.annotations': {
            ...
            'shared_with': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'null': 'True', 'through': "orm['annotations.Annotation_share_map']", 'symmetrical': 'False'}),
        ...
        'annotations.annotation_share_map': {
            'Meta': {'object_name': 'Annotation_share_map'},
            'annotations': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['annotations.Annotation']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

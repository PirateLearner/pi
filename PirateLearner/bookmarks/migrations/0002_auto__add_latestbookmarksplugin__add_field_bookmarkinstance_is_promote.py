...
#         db.create_unique(m2m_table_name, ['latestbookmarksplugin_id', 'tag_id'])
        ...
        # Adding field 'BookmarkInstance.is_promoted'
        db.add_column(u'bookmarks_bookmarkinstance', 'is_promoted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'BookmarkInstance.image_url'
        db.alter_column(u'bookmarks_bookmarkinstance', 'image_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
...
#         db.delete_table(db.shorten_name(u'bookmarks_latestbookmarksplugin_tags'))
        ...
        # Deleting field 'BookmarkInstance.is_promoted'
        db.delete_column(u'bookmarks_bookmarkinstance', 'is_promoted')


        # Changing field 'BookmarkInstance.image_url'
        db.alter_column(u'bookmarks_bookmarkinstance', 'image_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=200))
